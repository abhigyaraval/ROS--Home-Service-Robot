...
{
    ros::init(argc, argv, "add_marker_static");
    ros::NodeHandle n2;
    ros::Rate r(1);
    ros::Publisher marker_pub_static = n2.advertise<visualization_msgs::Marker>("visualization_marker", 1);
    ...
    // Publishing marker
    marker_pub_static.publish(marker);
